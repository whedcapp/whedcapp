...
*** Keywords ***
Delete project marked for deletion as other administrator should succeed
    ...
    Execute SQL String    CALL `whedcapp`.`project_update_writeSelf`(${uidAdmin[0][0]},'${TIME}',${result1[0][0]},'${start_date}','${end_date}',${proj_key},TRUE);    True
