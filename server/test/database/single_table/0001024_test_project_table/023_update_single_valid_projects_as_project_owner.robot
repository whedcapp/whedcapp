...
...                   Execute SQL String    CALL `whedcapp`.`project_update_writeSelf`(${uidOwner[0][0]},'${TIME}',${result1[0][0]},'${nstart_date}','${nend_date}',${nproj_key},${nproj_marked_for_deletion})    True
