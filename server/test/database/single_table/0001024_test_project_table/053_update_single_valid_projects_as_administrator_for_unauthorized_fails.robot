...
Update Some Combination
    ...
    Log Many    @{result1}
    Run Keyword And Expect Error     	EQUALS:InternalError: (1644, 'You are not allowed to update a/an PROJECT for others domain. You must be either an administrator or a project owner.')
