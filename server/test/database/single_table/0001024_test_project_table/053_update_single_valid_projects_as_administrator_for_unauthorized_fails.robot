...
Update Some Combination
    ...
    Log Many    @{result1}
    Run Keyword And Expect Error     	EQUALS:OperationalError: (1644, 'You are not allowed to update a/an PROJECT for others domain. You must be either an administrator or a project owner.')
...                   Execute SQL String    CALL `whedcapp`.`project_update_writeOther`(${uidAdmin[0][0]},'${TIME}',${result1[0][0]},${uidUser[0][0]},'${nstart_date}','${nend_date}',${nproj_key},${nproj_marked_for_deletion})    True
