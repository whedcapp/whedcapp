...
%type <ShPtr2VecOfShPtr2Table> CALL_STATEMENT
...
%type <ShPtr2VecOfShPtr2Table> CREATE_FUNCTION_STATEMENT
...
JOIN_PART: INNER_OUTER_FULL_STANDARD_JOIN JOIN ID ON ID EQ ID 
...
CONDITION:
  ...
  NOT CONDITION |
  CONJUNCTION | DISJUNCTION | FUNCTION_ID_OR_VALUE RELOP FUNCTION_ID_OR_VALUE | FUNCTION_ID_OR_VALUE | FUNCTION_ID_OR_VALUE IS NUL | FUNCTION_ID_OR_VALUE IS NOT NUL | FUNCTION_ID_OR_VALUE IN LEFT_PAR SET_OF_VALUES RIGHT_PAR
...
FUNCTION_ID_OR_VALUE:
  ID LEFT_PAR ID_OR_VALUE_LIST RIGHT_PAR | ID_OR_VALUE | TIMES | DISTINCT FUNCTION_ID_OR_VALUE
...
CREATE_FUNCTION_STATEMENT: CREATE FUNCTION {drv.atTopLevel = false; } ID LEFT_PAR PAR_LIST RIGHT_PAR RETURNS COL_TYPE_SPEC OPT_DETERMINISTIC WBEGIN STATEMENT_SECTIONS END {drv.atTopLevel = true; $$ = $STATEMENT_SECTIONS; }

OPT_DETERMINISTIC: /* empty */ | DETERMINISTIC
